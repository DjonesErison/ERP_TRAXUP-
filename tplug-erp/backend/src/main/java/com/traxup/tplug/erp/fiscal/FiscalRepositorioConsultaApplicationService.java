...
public class FiscalRepositorioConsultaApplicationService {
    ...
    public Resultado listar(UUID tenantId, LocalDate inicioSolicitado,
        ...
        List<Item> itens = jdbc.query("""
                ...
                tenantId, filtros.inicio(), filtros.fim(), filtros.status(),
                filtros.status(), filtros.limite());
    ...
    public record Item(UUID arquivoId, UUID documentoId, UUID tentativaId,
