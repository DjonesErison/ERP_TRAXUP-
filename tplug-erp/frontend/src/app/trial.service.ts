...
export interface TrialRequest { empresa:string; documento:string; responsavel:string; email:string; telefone:string; segmento:string; quantidadeLojas:number; senha:string; aceiteTermos:boolean; }
