...
- `V75` — coexistência das versões 1.0 e 1.1 do XML interno, com tributação congelada na 1.1.

## Regras para novas migrations

- Não editar migrations já aplicadas (`V1`–`V75`).
- A próxima migration deve usar `V76`.
