    ...
    <section class="inventory-shell">
      <header class="inventory-header">
        <div>
          ...
          <p>Acompanhe sessões, contagens e divergências do estoque da sua empresa.</p>
        </div>
