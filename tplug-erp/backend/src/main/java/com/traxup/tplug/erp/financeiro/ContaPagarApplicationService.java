...
public class ContaPagarApplicationService {
    ...
    private ContaPagar buscarParaAtualizacao(UUID tenantId, UUID contaId) { return repository.findByIdAndTenantIdForUpdate(contaId, tenantId).orElseThrow(() -> new RecursoNaoEncontradoException("Conta a pagar nao encontrada para o tenant informado")); }
